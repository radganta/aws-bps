...
locals {
	...
	AMIxSYSCTRL = {
		us-east-1 = "ami-0e903f128186a427f"
		us-east-2 = "ami-035780f7220e325d1"
		us-west-1 = "ami-002337d29c8d6f4da"
		us-west-2 = "ami-04db94fdc70704c3f"
		ap-east-1 = "ami-00000000000000000"
		ap-south-1 = "ami-0ef779433a8c1251e"
		ap-northeast-2 = "ami-0fbfb6c8d676e99c9"
		ap-southeast-1 = "ami-04dc55e34740bb039"
		ap-southeast-2 = "ami-0f2fe01a3162fa85c"
		ap-northeast-1 = "ami-07b001804d8e8f101"
		ca-central-1 = "ami-06508726c41a3c9fd"
		eu-central-1 = "ami-02b4382859b287db5"
		eu-west-1 = "ami-0a93a7e70116b3ddf"
		eu-west-2 = "ami-03c9b7639bf4d9279"
		eu-west-3 = "ami-0ba16727c8e375efc"
		eu-north-1 = "ami-0a096016ee589fa01"
		me-south-1 = "ami-00000000000000000"
		sa-east-1 = "ami-08dd4e48a5928a3b5"
	}
	AMIxVBLADE = {
		us-east-1 = "ami-02d69f72641ff4fb3"
		us-east-2 = "ami-0b83d7e119a7879c9"
		us-west-1 = "ami-0753d4fddf435cbd0"
		us-west-2 = "ami-03c074ec43a63c72d"
		ap-east-1 = "ami-00000000000000000"
		ap-south-1 = "ami-0eef8646d88761c3a"
		ap-northeast-2 = "ami-08ccd2ba192847146"
		ap-southeast-1 = "ami-0b1c90e1975da5d23"
		ap-southeast-2 = "ami-00e5c2d189181c152"
		ap-northeast-1 = "ami-019c8aac8329aefb7"
		ca-central-1 = "ami-0604fa07accd2822a"
		eu-central-1 = "ami-0f8c702587631e570"
		eu-west-1 = "ami-0fc8c4b65ae28fa93"
		eu-west-2 = "ami-0b29b165f503fc537"
		eu-west-3 = "ami-01c98486872beaa45"
		eu-north-1 = "ami-08acbbe07a8e6707c"
		me-south-1 = "ami-00000000000000000"
		sa-east-1 = "ami-06d47e2291965d955"
	}
	EC2xCONNECTxCIDR = {
